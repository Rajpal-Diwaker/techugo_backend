...
<div class="table-responsive tablewrap">
   <table id="table" class="w3-table-all">
         ...
         <tr class="item">       
          ...
          <a class="btn btn-success" href="<?php echo base_url('Admin/editTeam?teamId='.$value['tId']); ?>">Edit</a>          
                    
          <a class="btn btn-info" style="margin-top: 10px;" href="<?php echo base_url('Admin/viewTeam?teamId='.$value['tId']); ?>">View</a>         
