...
<div class="table-responsive">
   <table id="table" class="w3-table-all">
          ...
          <tr class="item">       
          <td><?php echo $i; ?></td>  
          <td><?php echo $value['block_UserName'];?></td>
          <td><?php echo $value['message'];?></td>
          <td><?php echo $value['Reported_userName'];?></td>
          <td>
          <?php if($value['deleted'] == 'Y') { ?>
          <button class="btn btn-success"><a href="<?php echo base_url('Admin/delete_user?id='.$value['report_user_id'].'&status=N&redirect=report&report_id='.$value['id']); ?>">Unblock</a></button>
          <?php } else { ?>
          <button class="btn btn-danger"><a href="<?php echo base_url('Admin/delete_user?id='.$value['report_user_id'].'&status=Y&redirect=report&report_id='.$value['id']); ?>">Block</a></button>
          <?php } ?>
             </td><?php $i++;?>
          </tr>
