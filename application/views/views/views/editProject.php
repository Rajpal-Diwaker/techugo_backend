...
<div class="form-group row">
      ...
      <div class="col-md-3 col-sm-4 col-xs-6 mobile-screen-form">
          ...
          <select id="project_incarge" name="project_incarge" class="form-control">  
          <option>-- Choose Project Incharge --</option>
       ...
       <div class="col-md-3 col-sm-4 col-xs-6 mobile-screen-form">
          ...
          <option>-- Choose Android Developer --</option>
       ...
       <div class="col-md-3 col-sm-4 col-xs-6 mobile-screen-form">
          ...
          <option>-- Choose Backend Developer --</option>
       ...
       <div class="col-md-3 col-sm-4 col-xs-6 mobile-screen-form">
          ...
          <option>-- Choose HTML Developer --</option>
       ...
       <div class="col-md-3 col-sm-4 col-xs-6 mobile-screen-form">
          ...
          <option>-- Choose QA Developer --</option>
